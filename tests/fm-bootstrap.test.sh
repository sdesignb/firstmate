...
make_routine_bootstrap_fixture() {
  ...
  printf '%s\n' '{"rules":[{"when":"normal work","use":{"harness":"codex","model":"gpt-5.5"}}],"default":{"harness":"claude","model":"claude-sonnet-5","effort":"low"}}' \
...
test_crew_dispatch_active_rules_are_verbose_bootstrap_info() {
  ...
  mkdir -p "$case_dir/home/config"
  printf '%s\n' manual > "$case_dir/home/config/backlog-backend"
  printf '%s\n' '{"rules":[{"when":"fresh news","use":{"harness":"grok","model":"grok-4.5"},"why":"current context"},{"when":"big feature","use":[{"harness":"claude","model":"claude-sonnet-5","effort":"high"},{"harness":"codex","model":"gpt-5.5","effort":"high"}]},{"when":"legacy feature","use":[{"harness":"claude","model":"claude-sonnet-5"},{"harness":"codex","model":"gpt-5.5"}],"select":"quota-balanced"}],"default":[{"harness":"pi","model":"anthropic/claude-sonnet-5","effort":"high"},{"harness":"grok","model":"grok-4.5","effort":"high"}]}' > "$case_dir/home/config/crew-dispatch.json"
  fakebin=$(make_fake_toolchain "$case_dir")
  add_real_jq "$fakebin"
...
unverified dispatch harness is flagged^{"rules":[{"when":"anything","use":{"harness":"spaceship","model":"space-model"}}],"default":{"harness":"codex","model":"gpt-5.5"}}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - unverified harness: spaceship
...
muse shared efforts are accepted^{"rules":[{"when":"muse low","use":{"harness":"muse","model":"muse-model","effort":"low"}},{"when":"muse medium","use":{"harness":"muse","model":"muse-model","effort":"medium"}},{"when":"muse high","use":{"harness":"muse","model":"muse-model","effort":"high"}},{"when":"muse xhigh","use":{"harness":"muse","model":"muse-model","effort":"xhigh"}},{"when":"muse max","use":{"harness":"muse","model":"muse-model","effort":"max"}}]}^empty^
unsupported muse ultra effort is flagged^{"rules":[{"when":"muse ultra","use":{"harness":"muse","model":"muse-model","effort":"ultra"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: muse:ultra
...
array use without select is accepted^{"rules":[{"when":"big feature","use":[{"harness":"claude","model":"claude-sonnet-5"},{"harness":"codex","model":"gpt-5.5"}]}]}^empty^
one-element array use is accepted^{"rules":[{"when":"focused feature","use":[{"harness":"claude","model":"claude-sonnet-5"}]}]}^empty^
default array is accepted^{"default":[{"harness":"pi","model":"anthropic/claude-sonnet-5"},{"harness":"grok","model":"grok-4.5"}]}^empty^
one-element default array is accepted^{"default":[{"harness":"codex","model":"gpt-5.5"}]}^empty^
...
unknown select is flagged^{"rules":[{"when":"big feature","use":[{"harness":"claude","model":"claude-sonnet-5"},{"harness":"codex","model":"gpt-5.5"}],"select":"mystery"}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - unknown select: mystery
array profile unsupported effort is flagged^{"rules":[{"when":"big feature","use":[{"harness":"codex","model":"gpt-5.5","effort":"max"}]}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: codex:max
...
default array malformed effort is flagged^{"default":[{"harness":"codex","model":"gpt-5.5","effort":3}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - default profile model and effort must be non-empty strings when present
